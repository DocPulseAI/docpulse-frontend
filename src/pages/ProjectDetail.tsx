  ...
  useEffect(() => {
    if (currentProject) {
      ...
      const loadLatestAnalysis = async () => {
        ...
        try {
          const docsRes = await documentsApi.list(currentProject.id)
          const latest = docsRes.data.documents[0]
            if (latest) {
              setLatestCommitHash(latest.commit)
            } else {
            setLatestCommitHash('')
          }
        } catch (err) {
          ...
          {activeTab === 'intelligence' && (
            <div className="cr-stack" style={{ gap: 24 }}>
              {analysisLoading ? (
                ...
                <div className="cr-doc-empty">No analyzed commit found for this project yet.</div>
              ) : (
                  ...
                  <div className="cr-analysis-card intel-panel border-l-4 border-l-blue-500">
                    <div className="cr-analysis-card-header intel-panel-header">
                      <div className="intel-panel-title-wrap">
                        ...
                        <span className="intel-panel-subtitle">Architectural insights and dependency mapping for this commit</span>
                      </div>
