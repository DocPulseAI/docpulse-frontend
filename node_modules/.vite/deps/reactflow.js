...
} from "./chunk-O5AICCWE.js";
import {
  require_react_dom
} from "./chunk-JDE3ZXWW.js";
import {
  drag_default,
  identity,
  pointer_default,
...
function Background({
  ...
  const { transform, patternId } = useStore(selector4, shallow$14);
...
function NodeToolbar({ nodeId, children, className, style: style2, isVisible, position = Position.Top, offset = 10, align = "center", ...rest }) {
  ...
  const { transform, nodeOrigin, selectedNodesCount } = useStore(storeSelector, shallow$15);
